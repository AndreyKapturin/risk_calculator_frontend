...
const objectsOfControl = [
    ...
    [
      ...
      new RiskIndicator(
        ...
        [
          ...
          new Criterion('200-700', 6),
          new Criterion('700-1000', 8),
          new Criterion('1000-5000', 12),
          new Criterion('Свыше 5000', 15),
        ]
      ),
      new RiskIndicator(
        'Наличие круглосуточного пребывания или проживания маломобильных групп населения, детей дошкольного и школьного возраста, пожилых людей старше 65 лет',
  ...
  new ObjectOfControl(
    'Объекты временного размещения людей, туризма и отдыха',
    50.3996761604334,
    [
      new RiskIndicator(
        'Степень огнестойкости',
  ...
  new ObjectOfControl(
    ...
    [
      ...
      new RiskIndicator(
        ...
        [
          new Criterion('Нет', 0),
          new Criterion('Не круглосуточно', -5),
          new Criterion('Круглосуточно', -10),
        ]
      ),
      new RiskIndicator(
        'Электропроводка выполнена более 10 лет назад и не подвергалась капитальному ремонту',
    ...
    [
      ...
      new RiskIndicator(
        ...
        [
          new Criterion('А, АН - для наружной установки', 8),
          new Criterion('Б, БН - для наружной установки', 8),
          new Criterion('В с долей помещений В1-В2 более 50%', 6),
          new Criterion('В с долей помещений В1-В2 менее 50%, ВН - для наружной установки', 6),
          new Criterion('Г, ГН -для наружной установки', 3),
          new Criterion('Д, ДН - для наружной установки', 0),
        ]
      ),
      new RiskIndicator(
